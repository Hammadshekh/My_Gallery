package com.example.ucrop.statusbar
...
object LightStatusBarUtils {
    ...
    fun setLightStatusBar(
        ...
        when (RomUtils.lightStatausBarAvailableRomType) {
            ...
            RomUtils.AvailableRomType.FLYME -> setFlymeLightStatusBar(activity,
                isMarginStatusBar,
                isMarginNavigationBar,
                isTransStatusBar,
                dark)
            RomUtils.AvailableRomType.ANDROID_NATIVE -> setAndroidNativeLightStatusBar(activity,
                isMarginStatusBar,
                isMarginNavigationBar,
                isTransStatusBar,
                dark)
