...
class UCrop {
    ...
    class Options {
        ...
        /**
         * Set one of [] The path that will be used to save
        ...
        fun setSkipCropMimeType(vararg mimeTypes: String?) {
            if (mimeTypes != null && mimeTypes.size > 0) {
                optionBundle.putStringArrayList(EXTRA_SKIP_CROP_MIME_TYPE,
        ...
        fun setMultipleCropAspectRatio(vararg aspectRatio: AspectRatio) {
            ...
            optionBundle.putParcelableArrayList(EXTRA_MULTIPLE_ASPECT_RATIO, ArrayList<Parcelable>(
                Arrays.asList(*aspectRatio)))
        }
