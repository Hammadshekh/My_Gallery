...
internal class Engine(srcImg: InputStreamProvider, private val tagImg: File, focusAlpha: Boolean) {
    ...
    fun compress(): File {
        ...
        tagBitmap!!.compress(if (focusAlpha || tagBitmap.hasAlpha()) Bitmap.CompressFormat.PNG else Bitmap.CompressFormat.JPEG,
            60,
            stream)
        tagBitmap.recycle()
